...
class ChatViewModel extends ChangeNotifier {
  ...
  void markVisibleMessagesViewed(Iterable<ChatMessage> visibleMessages) {
    // Ghost Mode: never advance TDLib's read cursor for incoming messages,
    // so no read receipt reaches the sender while it's on.
    if (GhostModeController.instance.enabled) return;
