...
class _ChatInputBarState extends State<ChatInputBar> {
  ...
  Future<void> _sendCurrentText() async {
    ...
    if (_selfDestructArmed) {
      vm.sendFormatted(buildSelfDestructText(text), const []);
      setState(() => _selfDestructArmed = false);
    } else {
  ...
  Widget _functionPanel() {
    final items = [
      (
        ...
        () => setState(() => _selfDestructArmed = !_selfDestructArmed),
      ),
      (
